...
Record references only. Never paste authentication material, private access configuration, account credentials, tester sign-in data, or customer content into this document or a public issue.
...
- acceptance account stored in approved restricted system:
...
- image-pull access verified:
- admin account stored in approved restricted system:
- beta acceptance account stored in approved restricted system:
- observability workspace:
- backup location:
