...
class ResearchPacketComparisonChainVerificationIntegrityRequest(BaseModel):
    verification_report_sha256: str = Field(min_length=64, max_length=64)
    content: dict[str, Any]


class ResearchPacketComparisonChainVerificationIntegrityResult(BaseModel):
    ...
    supported_report_types: list[str] = Field(
        default_factory=lambda: ["research_packet_comparison_chain_verification"]
    )
    detail: str
    disclaimer: str
