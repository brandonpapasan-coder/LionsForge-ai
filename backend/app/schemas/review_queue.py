...
class ReviewQueueComparisonVerificationReceiptValidation(BaseModel):
    contract_version: Literal["1.0"] = "1.0"
    artifact_type: Literal[
    ...
    current_state_checked: Literal[False] = False
    interpretation_notice: str = (
        "Validation confirms this uploaded receipt's contract and canonical digest only. It does "
