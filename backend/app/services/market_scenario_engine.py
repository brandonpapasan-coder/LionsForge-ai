...
def _deterministic_unit(*parts: object) -> Decimal:
...
def run_scenario(
    *,
    ...
    for step in range(1, steps + 1):
        noise_unit = _deterministic_unit(scenario_name, seed, initial_price, steps, step, "noise")
        normalized_noise = noise_unit * Decimal("2") - Decimal("1")
        return_rate = definition.drift + definition.volatility * normalized_noise

        shock_unit = _deterministic_unit(scenario_name, seed, initial_price, steps, step, "shock")
