...
@router.get("")
def get_roadmap_outcome_insights(
    ...
    return export_roadmap_outcome_insights(
        db,
        user=current_user,
...
def validate_roadmap_outcome_insights(
    payload: dict[str, Any] = Body(...),
    current_user: User = Depends(get_current_user),
) -> dict[str, Any]:
    del current_user
    return validate_roadmap_outcome_insight_bundle(payload)
