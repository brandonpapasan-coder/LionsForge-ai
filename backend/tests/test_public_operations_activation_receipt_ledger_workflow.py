...
WORKFLOW = Path(__file__).resolve().parents[2] / ".github" / "workflows" / "public-operations-activation-receipt-ledger.yml"
...
def test_workflow_rejects_unsafe_paths_and_retains_report() -> None:
    ...
    assert "validate_public_operations_activation_receipt_ledger.py" in value
