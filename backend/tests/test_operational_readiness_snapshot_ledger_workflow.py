...
WORKFLOW = Path(__file__).resolve().parents[2] / ".github" / "workflows" / "operational-readiness-snapshot-ledger.yml"
...
def test_workflow_rejects_unsafe_paths_and_preserves_boundary() -> None:
    ...
    assert "validate_operational_readiness_snapshot_ledger.py" in value
