...
WORKFLOW = Path(__file__).resolve().parents[2] / ".github" / "workflows" / "public-operations-freshness-receipt-ledger.yml"
...
def test_workflow_rejects_unsafe_paths_and_preserves_boundary() -> None:
    ...
    assert "validate_public_operations_freshness_receipt_ledger.py" in value
