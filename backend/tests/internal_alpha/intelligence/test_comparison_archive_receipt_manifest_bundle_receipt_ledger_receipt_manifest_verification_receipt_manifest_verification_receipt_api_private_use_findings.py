...
@pytest.mark.parametrize("finding", ["digest\ue000mismatch", "digest\U000f0000mismatch", "digest\U00100000mismatch"])
def test_validate_route_replaces_private_use_finding_with_generic_failure(
...
@pytest.mark.parametrize("finding", ["digest\ue000mismatch", "digest\U000f0000mismatch", "digest\U00100000mismatch"])
def test_create_route_rejects_private_use_post_build_finding(
    monkeypatch, finding: str
) -> None:
    monkeypatch.setattr(
        routes,
...
def test_validate_route_preserves_unassigned_public_scalar(monkeypatch) -> None:
