...
def test_validate_route_replaces_unicode_line_separator_finding_with_generic_failure(
...
def test_create_route_rejects_unicode_line_separator_post_build_finding(
    monkeypatch, finding: str
) -> None:
...
def test_validate_route_preserves_non_breaking_space_finding(monkeypatch) -> None:
